...
namespace ECS
{
    class ComponentsManager {
        public:
            ...
            template<class C>
            void RegisterComponent(std::unique_ptr<AComponent> component)
            {
                p_registeredComponents[component->GetComponentName()] = std::move(component);
                p_registeredComponentsName.push_back(component->GetComponentName());
            }
