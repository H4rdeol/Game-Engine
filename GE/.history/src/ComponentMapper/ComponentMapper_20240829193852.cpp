...
// ? Vérifier si je peux pas utiliser plutot une Interface qui aurait une méthode AddToEntity comme ça moins de méthode dans la classe mapper au lieu de 36 overload
